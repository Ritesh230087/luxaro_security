...
exports.updatePassword = async (req, res) => {
  try {
    ...
    // ✅ FIX 2: Check if new password is same as current
    ...
    // ✅ FIX 3: Full password validation (same as register)
    ...
    // ✅ FIX 4: Check for common passwords
    ...
    // ✅ FIX 5: Check password history (prevent reuse)
...
exports.disable2FA = async (req, res) => {
  try {
    ...
    // ✅ FIX: req.user._id is now available because protect middleware is added
