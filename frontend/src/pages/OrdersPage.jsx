            ...
            <div className="summary-sidebar">
              <div className="info-card gold-border">
                ...
                {selectedOrder.discount > 0 && (
                  <div className="s-row" style={{color: '#4ade80'}}><span>Discount</span><span>- Rs. {selectedOrder.discount?.toLocaleString()}</span></div>
                )}
      ...
      <div className="container">
        ...
        {orders.length === 0 ? (
          <div className="empty-state" style={{textAlign: 'center', padding: '100px'}}>
            ...
            <Link to="/shop" className="btn-gold">Explore Shop</Link>
          </div>
        ) : (
